...
public class GregorianLunarCalendarView extends LinearLayout implements NumberPickerView.OnValueChangeListener {
    ...
    private static final int YEAR_START = Calendar.getInstance().get(Calendar.YEAR) - 30;
    private static final int YEAR_STOP = Calendar.getInstance().get(Calendar.YEAR);
